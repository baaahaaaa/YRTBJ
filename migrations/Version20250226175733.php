...
final class Version20250226175733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidat (id INT AUTO_INCREMENT NOT NULL, internship_id INT DEFAULT NULL, student_id INT DEFAULT NULL, date_candidature DATE NOT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(8) NOT NULL, full_name VARCHAR(255) NOT NULL, result TINYINT(1) NOT NULL, cv_filename VARCHAR(255) DEFAULT NULL, INDEX IDX_6AB5B4717A4A70BE (internship_id), INDEX IDX_6AB5B471CB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, entry_date DATE DEFAULT NULL, password VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, domain VARCHAR(255) DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, company_name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
